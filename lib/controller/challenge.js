...
app.controller('ChallengeController', function ($scope, $routeParams, $window, $timeout, $rootScope, contentService) {
    ...
    function loadChallenge() {
        contentService.getChallenge($scope.worldId, $scope.id).then(function (challenge) {
            var lsCode = localStorage["code_" + $scope.worldId + "_" + $scope.id];
            ...
            $scope.validator = getValidator($scope.content.steps, $scope.content.ignoreUntil);
    ...
    $scope.validate = function () {
        ...
        setTimeout(function () {
            ...
            report = $scope.validator.validate(code);
