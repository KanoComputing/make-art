...
app.controller('ChallengeController', function ($scope, $routeParams, $window, $timeout, ngAudio) {
    ...
    function startAnimating () {
        ...
        $scope.animationClass = "enable_animation";
        $timeout(resetAnimation, 2000);
