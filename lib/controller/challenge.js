...
app.controller('ChallengeController', function ($scope, $routeParams, $window) {
    ...
    $scope.successMessage = function () {
        ...
        var xpMessage = ' and earned ' + $scope.xpGain + 'xp!';

        var onlineMessage = SUCCESS_MESSAGES[$scope.id % SUCCESS_MESSAGES.length] +
            ' You completed challenge ' + $scope.id;
        var offlineMessage = onlineMessage + xpMessage;
