...
var api,
    //null
    DEFAULT_SUCCESS_MESSAGE = 'Well done!',
...
app.controller('ChallengeController', function ($scope, $routeParams, $window, $timeout, $rootScope, $location, contentService, emailService, socialService, _config) {
    ...
    function loadChallenge() {
        contentService.challenge.get($scope.worldId, $scope.id).then(function (challenge) {
            ...
            console.log('$scope.validator=>',$scope.validator)
    ...
    $scope.validate = function () {
        ...
        timer = setTimeout(function () {
            ...
            console.log(report.lastValidStep)
