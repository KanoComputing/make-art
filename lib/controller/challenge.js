...
app.controller('ChallengeController', function ($scope, $routeParams, $window, $timeout, $rootScope, $location, contentService, securityService) {
    ...
    function init() {
        ...
        if (!$rootScope.inWorldProgress) {
            $rootScope.inWorldProgress = securityService.progress.get($scope.worldId);
        }
    }
