...
var SUCCESS_MESSAGES = [
        ...
        'What a winner! Nice work. Try changing the colors and see what you can make.', //Medal
        'Mathmatical! Change the numbers and see what happens.', //Dots
        'Tasty! Finish it off with more toppings, let youe imagine run wild and see what you can make', //Pizza
        'Well done!', //null
    ],
