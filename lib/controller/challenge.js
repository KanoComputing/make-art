...
app.controller('ChallengeController', function ($scope, $routeParams, $window, $timeout, $rootScope, $location, contentService, socialService, _config) {
    ...
    $scope.validate = function () {
        ...
        timer = setTimeout(function () {
            ...
            if (finished && !$scope.completed) {
                Telemetry.trackEvent({ name: 'tutorial_completed' });
