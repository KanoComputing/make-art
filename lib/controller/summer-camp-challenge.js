...
app.controller('SummerCampChallengeController', function ($scope, $routeParams, $window, $timeout, $rootScope, $location) {
    ...
    // Check if the difference in the route params and the current day of summercamp is greater than 0
    ...
    if (!config.TEST_MODE && ($scope.id - diff) > 0 && $scope.id >= progressNo) {
