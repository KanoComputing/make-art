...
app.controller('PromoPopupController', function ($scope, $rootScope, $routeParams) {
    var cfg =  {
        'none': {
    ...
    init = function () {
        ...
        if (promoPopupOpen !== ts && worldId === "mischiefweek2015" && $rootScope.progress.groups[worldId].challengeNo > 2) {
