...
app.controller('ChallengesController', function($scope, $rootScope, $routeParams, $location, $http, contentService, _config, activationService) {
    ...
    function init() {
        ...
        contentService.world.getAll().then(function gotWorlds(data) {
            ...
            if (activationService.isActivationRequired()) {
