...
app.controller('ChallengesController', function ($scope, $rootScope, $routeParams, $location, $http, contentService) {
    var ACTION_URL = 'https://docs.google.com/forms/d/1nTJ-waAVLQCO3myxKMDQLafL5Fnf9uTPtiejuH-74sY/formResponse',
    ...
    $scope.submit = function () {
        ...
        $scope.error = '';
        data = { 'entry.1965349241': $scope.formData.email };

        postEmail(data, function () {
            $scope.error = '';
