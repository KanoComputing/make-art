...
export default function (cfg) {
    ...
    function load(callback) {
        ...
        console.log('progress.js offline load => 1')
        ...
        api.progress.load().then(function (res) {
            var data = res.body;
            console.log('api progress.js offline load => 2')
