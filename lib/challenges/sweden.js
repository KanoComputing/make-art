...
module.exports = {
    ...
    steps       : generate.fromSequence([
        ...
        [
            'Move on top towards the left - In a new line, **type** `moveTo 150, 0`',
            'moveTo 150',
            [
                [ 'move-to', { x: 150, y: 0 } ]
            ]
        ...
        [
            'Draw the first rectangle - In a new line, **type** `rectangle 50, 470`',
            'rectangle 50, 470',
            [
        ...
        [
            'Draw the second rectangle - In a new line, **type** `rectangle 470, 50`',
            'rectangle 470, 50',
            [
