 ...
 * @param  {array} steps        The steps to validate against
 * @param  {int}   ignoreUntil  0 indexed number of steps that need to be ignored
 * @return {object}             A validator
 */
module.exports = function (steps, ignoreUntil)  {
     ...
     * @return {string}      The escaped rule
     */
    completeRegex = function (rule) {
        //change the first space into after the a word into a .
    ...
    validator = {
        ...
        validate: function (code) {
            ...
            if (ignoreUntil) {
                //if the are steps to ignore, we remove the lines
                lines.splice(0, ignoreUntil + 1);
            }
