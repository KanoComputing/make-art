...
module.exports = {
    ...
    steps       : generate.fromSequence([
        [
            'Set the color to blue - In a new line, **type** `color blue`',
            'color red',
            [
        ...
        [
            'Draw a circle with size 100 - **type** `circle 100`',
            'circle 100',
            [
        ...
        [
            'Move at the end of the knot - **type** `move 0, 15`',
            'move 0, 15',
            [
                [ 'move-to', { dx: 0, dy: 15 } ]
            ]
        ...
        [
            'Choose a tick black stroke - **type** `stroke black, 5`',
            'stroke black, 5',
            [
