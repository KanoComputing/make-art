...
module.exports = {
    ...
    title       : 'Lights on!',
    short_title : 'Torch',
    icon_class  : 'challenge_torch',
    description : 'Torch info',
    img         : '/assets/summercamp/ch_pics/day_12.png',
    completion_text: 'More torch',
    difficulty  : 1,
    startAt     : 0,
    rewards     : null,
    summerCamp  : true,
    steps       : generate.fromSequence([
        [
            'It\'s getting dark outside here! Set the `background` color to `darkblue`',
            'background darkblue',
            [
        ...
        [
            'Move the cursor to place our torch - **type** `moveTo 200, 200`',
            'moveTo 200, 200',
            [
                [ 'move-to', { x: 200, y: 200 } ]
            ]
        ...
        [
            'Set the `color` of the torch to `dimgray`',
            'color dimgray',
            [
        ...
        [
            'Draw the head of the torch with a rectangle - **type** `rectangle 100, 50`',
            'rectangle 100, 50',
            [
        ...
        [
            'Draw the body of the torch with a `rectangle` `60` by `200`',
            'rectangle 60, 200',
            [
        ...
        [
            'Place the beam in front of the torch - **type** `move -50, -140`',
            'move -50, -140',
            [
