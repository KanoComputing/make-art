...
//        ],
        [
            'For a cool 3D effect, lets change the drawing color to `green`',
            'color green',
            [
                [ 'color', { color: palette.green } ]
            ]
        ...
        [
            '**Draw** the net: a rectangle a width of 4, and height of 80',
            'rectangle 4, 80',
            [
        ...
        [
            ...
            [
                ['var', function (opts) {
                    value = 'random 40, 460';
                    return (opts.name === 'x' && opts.value === value.replace(/ /g, ''));
                }]
            ]
        ],
        [
            'Use a Sine function to decide how high the ball should be, and make your ball bounce over the net! **Type** `y = Math.sin(x / 50) * 60 + 200`',
            'y = Math.sin(x / 50) * 60 + 200',
            [
                ['var', function (opts) {
                    value = 'Math.sin(x / 50) * 60 + 200';
                    return (opts.name === 'y' && opts.value === value.replace(/ /g, ''));
                }]
            ]
        ],
        [
