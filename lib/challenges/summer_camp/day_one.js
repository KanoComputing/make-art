...
module.exports = {
    ...
    steps       : generate.fromSequence([
        ...
        [
            'That sign looks too clean, draw some imperfections. First set the color to blue',
            'color blue',
            [
        ...
        [
            ...
            'stroke 5, brown',
            [
                [ 'stroke-width', { color: palette.brown }, { width: 5 } ]
            ]
        ],
        [
            ...
            'moveTo 100, 220',
            [
                [ 'move-to', { dx: 100, dy: 220 } ]
            ]
        ],
        [
            'Draw a polygon for the shape - **type** `polygon 0, 0, 16, 10, 0, 11`',
            'polygon 0, 0, 16, 10, 0, 11',
            [
                [ 'polygon', { points: [
                    { x: 0, y: 0 },
                    { x: 16, y: 10 },
        ...
        [
            'We need some text in that sign. Move the cursor to place the text - **type** `moveTo 250, 220`',
            'moveTo 250, 270',
            [
                [ 'move-to', { dx: 250, dy: 270 } ]
            ]
        ],
        [
