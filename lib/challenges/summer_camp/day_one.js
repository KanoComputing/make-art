...
module.exports = {
    ...
    description : 'Welcome to Summer Camp! You have three weeks of  \ndaily fun creative challenges in front of you. At the end of each challenge you will have the option to wow everyone with your own additions and customisations. Also, don\'t forget to share your creation with the world!',
    img         : '/assets/summercamp/ch_pics/day_1.png',
    completion_text: 'Well done! Now give your camp its own name and style! Change the text, the color of the sign... why not adding a nice background and some extra decorations?',
    difficulty  : 1,
    startAt     : 0,
    rewards     : null,
    summerCamp  : true,
