...
module.exports = {
    ...
    steps       : generate.fromSequence([
        [ 
            'It\'s a sunny day! Set the background color to blue - **type** `a = 3`',
            'a = 3',
            [
                ['var', function (opts) {
        ...
        [ 
            'It\'s a sunny day! Set the background color to blue - **type** `x = Math.random() * stage.width`',
            'x = Math.random() * stage.width',
            [
                ['var', function (opts) {
                    return (opts.name === 'x' && opts.value ==='Math.random()*stage.width');
                }]
            ]
            
        ],
        [ 
            'It\'s a sunny day! Set the background color to blue - **type** `y = Math.sin(x / 50) * 60 + 200`',
            'y = Math.sin(x / 50) * 60 + 200',
            [
                ['var', function (opts) {
                    return (opts.name === 'y' && opts.value ==='Math.sin(x/50)*60+200');
                }]
            ]
            
        ],
        [ 
            'It\'s a sunny day! Set the background color to blue - **type** `b = "Hello"`',
            'b = Hello',
            [
                ['var', function (opts) {
                    return (opts.name === 'b' && opts.value ==='"Hello"');
                }]
            ]
