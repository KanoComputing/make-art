    ...
    steps       : generate.fromSequence([
        ...
        [
            ...
            [
                ['var', function (opts) {
                    console.log(opts);
                    console.log(opts.name === 'x' && opts.value === 'random0,500');
        ...
        [
            'Now let’s draw some clouds. First set `stroke 0`',
            'stroke 0',
            [
        ...
        [
            ...
            [
                ['var', function (opts) {
                     return (opts.name === 'x' && opts.value >= 0 && opts.value <= 500 );
                }]
            ]
        ],
        [
            ...
            [
                ['var', function (opts) {
                    return (opts.name === 'y' && opts.value >= 300 && opts.value <= 500);
                }]            ]
        ],
        [
            'Now with our x and y values set we can move the cursor to them. **Type** `moveTo x, y`',
        ...
        [
            'Set the drawing color to red - **type** `color blue`',
            'color red',
            [
