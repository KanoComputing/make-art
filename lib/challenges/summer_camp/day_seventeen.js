...
module.exports = {
    ...
    steps       : generate.fromSequence([
        ...
        [
            'Create a wave out of an arc with a radius of 20 - **type** `arc 20, 0.8, 0.2`',
            '    arc 20, 0.8, 0.2',
            function () {
                var out = [],
                i = 1;
        ...
        [
            'Draw a big rectangle 500 high and 250 wide for the water',
            'rectangle 500, 250',
            [
        ...
        [
            'Draw a line that is 150 wide and 400 tall',
            'line 150, 400',
            [
                [ 'line', { dx: 150, dy: 400 } ]
            ]
        ...
        [
            'To see if a fish is biting we are going to draw a cork. Move to the end of the fishing line by typing `move -100, (random 197, 202)`',
