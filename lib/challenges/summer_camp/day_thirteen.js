...
module.exports = {
    ...
    description : 'Guitar info',
    img         : '/assets/summercamp/ch_pics/day_13.png',
    completion_text: 'Add more stuff',
    difficulty  : 2,
    startAt     : 0,
    rewards     : null,
    summerCamp  : true,
    steps       : generate.fromSequence([
        ...
        [
            'Let\'s draw the 4 strings with a loop - **type** `for i in [ 0 .. 3 ]`',
            'for i in [ 0 .. 3 ]',
            [
                [ 'for-loop', { iterator: 'i', range: '0..3' } ]
            ]
        ],
        [
            'Draw a string using a `line` - **type** `line 250, 0`',
            '    line 250, 0',
            function () {
                var i = 0,
                    out = [];
        ...
        [
            'You are ready to play music! Set the `color` to `white`.',
            'color white',
            [
        ...
        [
            'Start a new loop - **type** `for i in [ 0 .. 10 ]`',
            'for i in [ 0 .. 10 ]',
            [
