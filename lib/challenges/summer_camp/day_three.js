...
module.exports = {
    ...
    steps       : generate.fromSequence([
        ...
        [
            ...
            'moveTo 100, 350',
            [
                [ 'move-to', { dx: 100, dy: 350 } ]
            ]
        ],
        [
            'Draw a triangle using `polygon` - **type** `polygon 0, 0, 150, -200, 300, 0`',
        ...
        [
            'Draw the entrance - **type** `polygon 0, 0, 30, 200, -30, 200`',
            'polygon 0, 0, 30, 200, -30, 200',
            [
                [ 'polygon', { points: [
                    { x: 0, y: 0 },
                    { x: 30, y: 200 },
