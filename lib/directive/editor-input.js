...
import number from '../editor/token-handler/NumberHandler.js';
import color from '../editor/token-handler/ColorHandler.js';
...
app.directive('editor', function ($rootScope, $controller, $compile, _config) {
    return {
        require     : '^workspace',
        restrict    : 'E',
        ...
        link        : function (scope, element, attrs, workspaceCtl) {
            var options = EDITOR_DEFAULTS,
                ...
                engine, session, activeToken, tokenHandler, lastFocused, keepToken, preventMove;
            /*
