    ...
    return {
        ...
        link        : function (scope) {
            ...
            function init() {
                ...
                if (location.match(/mischiefweek2015/)) {
                    scope.category = true;
                }
            ...
            scope.facebookShare = function (challenge) {
                ...
                //     caption : 'Shared by ' + challenge.username + ' through Mischief Week',
            ...
            // function getLastShare () {
            //     console.log('bkvbdvdbkbvkjdbk');
            //     api.online.share.list({}, {limit: 3, user_id: $rootScope.user.id})
            //     .then(function(data) {
