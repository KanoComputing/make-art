...
app.directive('socialSharing', function ($rootScope, socialService, emailService, _config) {
    return {
        restrict: 'E',
        templateUrl : i18n.getHtmlLocalePath(_config.APP_ROOT) + '/directive/social.html',
        scope: {
            type: '='
        },
        link : function (scope) {
