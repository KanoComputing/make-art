...
app.run(function ($rootScope, $window) {
    ...
    $rootScope.progress['summercamp'].challengeNo = parseInt(localStorage.groups['summercamp'].challengeNo || 0, 10);
    ...
    auth.init(function () {
        ...
        api.progress.load(function (challengeNo, groups) {
            ...
            $rootScope.progress.groups['summercamp'].challengeNo = groups['summercamp'].challengeNo || 1;
            $rootScope.$apply();
        });
