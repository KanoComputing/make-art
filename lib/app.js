...
window.CONFIG = angular.extend(config.default, config[window.ENV]);
var auth = require('./core/auth')(window.CONFIG),
    api = require('./api')(window.CONFIG);
...
app.run(function ($rootScope, $window) {
    ...
    $rootScope.offline = window.CONFIG.OFFLINE;
