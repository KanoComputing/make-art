...
var util_1 = util.stringifyIfObject;
var util_2 = util.formRequestPayload;
var util_3 = util.parseIfJSON;
var util_4 = util.compileRoute;
...
!function(undefined$1) {
  ...
  function configure(conf) {
    if (conf) {
      ...
      this._events.maxListeners = conf.maxListeners !== undefined$1 ? conf.maxListeners : defaultMaxListeners;
...
var Resource_1 = Resource;

Resource_1.prototype._Request = XMLHttpRequest;

var ResourceBrowser = Resource_1;

var apiResource = createCommonjsModule(function (module) {
{
...
var attachToNamespace = function (root, ns, val) {
...
var util$1 = {
	attachToNamespace: attachToNamespace
};

var eventemitter2$1 = createCommonjsModule(function (module, exports) {
!function(undefined$1) {
...
var eventemitter2_1 = eventemitter2$1.EventEmitter2;

var EventEmitter$1 = eventemitter2$1.EventEmitter2;
...
function Service (baseUrl) {
    EventEmitter$1.call(this, { wildcard: true });
...
Service.prototype = Object.create(EventEmitter$1.prototype);
...
Service.prototype.add = function (ns, options) {
    ...
    resource = new apiResource(options);
    ...
    util$1.attachToNamespace(this, ns, resource.query.bind(resource));
